...
int main(int argc, char**argv) {
    ...
    if (!load_16bit_data("/opt/code_chap8/data/neuron", neuron) ||
        !load_16bit_data("/opt/code_chap8/data/weight", weight) ||
        !load_32bit_result("/opt/code_chap8/data/result", expected_result)) {
        return 1;
    }
