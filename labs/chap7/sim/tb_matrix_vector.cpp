...
int main(int argc, char**argv) {
    ...
    if (!load_config("/opt/code_chap8/data/config", vec_size) ||
        !load_16bit_data("/opt/code_chap8/data/neuron", activations) ||
        !load_16bit_data("/opt/code_chap8/data/weight", weights) ||
