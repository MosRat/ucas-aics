...
def build_mnist_mlp(*args) -> CommitWrapper:
    import inspect
    import sys
    ...
    hp = dict(epochs=int(10), batch_size=int(10000), lr=0.11, momentum=0.9)
    model = build_model()
    # model = train(**hp)
    ...
    # )
    s = np.load(Path(__file__).parent / "weight.npy", allow_pickle=True).item()
    # print(type(s))
